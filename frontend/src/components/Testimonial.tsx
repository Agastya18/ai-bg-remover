...
const Testimonial = () => {
  return (
    <div>
        <h1 className=' text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-slate-600 to-gray-500  bg-clip-text text-transparent'>
